...
[![](img/57a42310Nbab48a67.jpg)](http://union-click.jd.com/jdc?d=SFEPja)
...
由于 Angular2 应用采用 TypeScript 开发，构建和前面讲过的[(3.2 使用 TypeScript 语言](3-2使用TypeScript语言.html) 类似，不同在于 `tsconfig.json` 配置。 由于 Angular2 项目中采用了注解的语法，而且 `@angular/platform-browser` 源码中有许多 DOM 操作，配置需要修改为如下：
...
> 本实例<a href="../zip/3-8使用Angular2框架.zip" target="_blank">提供项目完整代码</a>
